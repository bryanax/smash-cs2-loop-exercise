...
that specifies how many squares the function needs to draw. Your task is to use a while loop
to draw 'num' number of rectangles at random positions and with some random size in the canvas.
Don't forget to fill() in your shapes with various colors!
